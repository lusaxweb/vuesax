<template lang="html">
  <div class="centerx">
    <vs-button @click="popupActivo2=true" vs-type="primary-filled">Open Popup</vs-button>
    <vs-popup  vs-title="Lorem ipsum dolor sit amet" :vs-active="popupActivo2" @vs-cancel="popupActivo2=false">
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
      </p>
      <vs-button @click="popupActivo3=true" vs-type="primary-filled">Open Inner Popup</vs-button>
