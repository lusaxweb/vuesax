<template lang="html">
  <label ref="checkBoxx" :disabled="disabled" :class="[{'disabledx':disabled,'checkBoxActivo':typeof value == 'boolean'?value:valueArray}]"  class="con-check">
    <!-- v-bind="$attrs" -->
    <!-- v-on="$listeners" -->
    <input
      v-on="listeners"
      type="checkbox"
      :checked="typeof value == 'boolean'?value:valueArray">
